...
<div class="container">
	...
	<div id="success" class="alert alert-success" role="alert">Real
		estate agency has been added to the list successfully.</div>
	<div id="error" class="alert alert-danger" role="alert">Failed to
		add agency</div>
			...
			<form name="register-form" id="register-form" method="post" action="">
				<div class="col-sm-12">
					...
					<div class="row">
						...
						<div class="col-sm-3 form-group required">
							<label class="control-label" for="locality">Locality</label> <input
								type="text" name="locality" class="form-control" id="locality"
