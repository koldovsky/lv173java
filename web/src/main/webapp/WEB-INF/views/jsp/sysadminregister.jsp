...
<script src="resources/js/sysadminregister.js"></script>
...
<body>
	<div class="container">
		...
		<div class="col-lg-12 well">
			<div class="row">
				<form name="sysadminregisterform" id="sysadminregisterform"
					action="">
					<div class="col-sm-6">
						<!-- New system adminstrator login-->
						<div class="form-group">
							<label class="control-label" for="sysadminlogin">New
								system administrator login</label> <input type="text"
								class="form-control" name="sysadminlogin" id="sysadminlogin"
